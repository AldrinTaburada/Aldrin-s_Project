          ...
          <div class="d-xl-flex justify-content-between align-items-start">
            ...
            <body>
              ...
              <div style="display: inline-flex;">
                ...
                <div
                  style="width: 300px; height: 300px; position: relative;margin-top: 20vh;margin-left: -10vh; gap: 9rem;">
                  <canvas id="myChart" style="width: 70%; height: 40vh;"></canvas>
                </div>

                <script>
                  const xValues = ["Male", "Female"];
                  const yValues = [3, 1];
                  const barColors = ["#b91d47", "#00aba9", "#00ffab"];
                ...
                <canvas id="myBarChart" style="width: 20vh; margin-top: 10vh;height:20vh;"></canvas>
                ...
                <script>
                  ...
                  // Data for the activities (you can replace these values with your data)
                  const activities = [10, 15, 20, 25, 30, 35, 40, 45, 50, 45, 40, 35];

                  // Define an array of 12 different RGBA colors
                  const monthColors = [
                    "rgba(75, 192, 192, 0.6)",
                    "rgba(255, 99, 132, 0.6)",
                    "rgba(54, 162, 235, 0.6)",
                  ...
                  new Chart("myBarChart", {
                    ...
                    data: {
                      ...
                      datasets: [{
                        label: "Activities",
                        data: activities,
                        backgroundColor: monthColors, // Use the array of colors
